...
public static TreeSet<Producto> listaProducto=new TreeSet<>();
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
       ...
       bpn.setVisible(true);
       jDesktopPaneEscritorio.add(bpn);
...
private void cargarProducto(){
    ...
    listaProducto.add(new Producto(123, "Azucar", 180.5, 15, Categoria.COMESTIBLES));
    listaProducto.add(new Producto(152, "Galletitas", 380.5, 5, Categoria.COMESTIBLES));
    listaProducto.add(new Producto(112, "Aceite", 1800.1, 10, Categoria.COMESTIBLES));
    listaProducto.add(new Producto(126, "Lavandina", 800.1, 18, Categoria.LIMPIEZA));
    listaProducto.add(new Producto(196, "Detergente", 600.1, 20, Categoria.LIMPIEZA));
    listaProducto.add(new Producto(192, "jabon", 100.1, 29, Categoria.LIMPIEZA));
    listaProducto.add(new Producto(164, "Desodorante", 505.1, 27, Categoria.PERFUMERIA));
    listaProducto.add(new Producto(148, "crema manos", 985.1, 27, Categoria.PERFUMERIA));
    listaProducto.add(new Producto(154, "shampoo", 505.1, 27, Categoria.PERFUMERIA));
